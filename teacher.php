   ...
   <!-- Fixed navbar -->
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<img src="logo.png" alt="Welcome to SRM" width="120" height="70" >
    <h2><a class="navbar-brand" href="index.php" style="font-size:28px;">SRM Institute of Science and Technology</a></h2>
