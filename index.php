    ...
    <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
	     ...
	     <a class="navbar-brand" href="index.php" style="font-size:28px;"><br>SRM Institute of Science and Technology</a><br />
    ...
    <table class="table table-bordered table-striped">
     ...
     <!-- FOOTER -->
      <footer style="background; height:140%;">
        ...
        <p>&copy; 2019 SRM, Inc. &middot;  developed by  <a href="https://localhost:81/AMS/index.php">Anish and Anvesh </a><a href="http://localhost:81/AMS/index.php"> &middot; Privacy</a> &middot; <a href="http://index.php">Terms</a></p>
      </footer>
